...
class Util {
  ...
  static deviceConfig = [
    ...
    {
      "hostname": ["shellywalldisplay-", "ShellyWallDisplay-", "shellywalldisplayx2-", "ShellyWallDisplayX2-", "shellywalldisplayxl-", "ShellyWallDisplayXL-"],
      "name": "Shelly Wall Display",
      "gen": "gen2",
      "type": ["SAWD-0A1XX10EU1", "SAWD-2A1XX10EU1", "SAWD-3A1XE10EU2"],
    ...
    {
      "hostname": ["shellywalldisplay-thermostat-", "ShellyWallDisplay-thermostat-", "shellywalldisplayx2-thermostat-", "ShellyWallDisplayX2-thermostat-", "shellywalldisplayxl-thermostat-", "ShellyWallDisplayXL-thermostat-"],
    ...
    {
      "hostname": ["shellyplusrgbwpm-rgbw-", "ShellyPlusRGBWPM-rgbw-", "ShellyPlusRGBWPM-", "shellyplusrgbwpm-"],
    ...
    },
    {
      ...
      "gen": "gen2",
      "type": ["SBBT-004CEU", "SBBT-104CEU", "SBBT-EU"],
    ...
    {
      "hostname": ["shellyplugpmg3-", "ShellyPlugPMG3-", "shellyplugpmgen3", "ShellyPlugPMGen3-"],
      ...
      "battery": false,
      "class": "socket",
      "capabilities_1": ["measure_power", "meter_power", "measure_voltage", "measure_current", "measure_temperature", "rssi", "button.enable_ble_script", "button.disable_ble_script", "deviceGen3", "devicePlusPlugS"],
      "capabilities_2": [],
      "capability_options": {
        "measure_temperature": {"title": {"en": "Device Temperature", "nl": "Apparaattemperatuur"}},
        "button.enable_ble_script": {"maintenanceAction": true, "title": {"en": "Start BLE Proxy", "nl": "Start BLE Proxy"}},
    ...
    {
      hostname: ["shellypstripg4-", "shellypstripg4--", "ShellyPStripG4-"],
    ...
    {
      hostname: ['shellydimmerg4-', 'ShellyDimmerG4-'],
      ...
      battery: false,
      class: 'light',
      capabilities_1: ["onoff", "dim", "measure_power", "measure_current", "meter_power", "measure_temperature", "input_1", "input_2", "rssi", "actionEvents", "button.enable_ble_script", "button.disable_ble_script", "deviceGen4", "multiInputs"],
      capabilities_2: [],
      capability_options: {
        measure_temperature: { title: { en: "Device Temperature", nl: "Apparaattemperatuur"}},
        dim: { opts: { duration: true }},
    ...
    {
      "hostname": ["shellybludistance-", "ShellyBLUDistance-"],
      "name": "Shelly BLU Distance",
      "gen": "gen2",
      "type": ["SBDI-003E"],
      "id": "shellybludistance",
      "channels": 1,
      "communication": "bluetooth",
      "battery": true,
      "class": "button",
      "capabilities_1": ["measure_distance", "alarm_vibration", "measure_battery", "deviceBLU"],
      "capabilities_2": [],
      "capability_options": {},
      "settings": {},
      "energy": {"batteries": ["OTHER"]},
      "triggers_1": [],
      "triggers_2": [],
      "callbacks": [],
      "icon": "../../../assets/icons/shellybludistance.svg",
      "extra": {}
    },
    {
      hostname: ["ogemray25a-", "Ogemray25A-"],
      name: "Ogemray 25A",
      gen: "gen3",
      type: ["Ogemray25A"],
      id: "ogemray25a",
      ...
      battery: false,
      class: "socket",
      capabilities_1: ["onoff", "measure_power", "meter_power", "measure_voltage", "measure_current", "measure_temperature", "input_1", "rssi", "button.enable_ble_script", "button.disable_ble_script", "actionEvents", "deviceGen3"],
      capabilities_2: [],
      capability_options: {
        measure_temperature: {title: {en: "Device Temperature", nl: "Apparaattemperatuur"}},
        "button.enable_ble_script": {maintenanceAction: true, title: {en: "Start BLE Proxy", nl: "Start BLE Proxy"}},
      ...
      triggers_2: [],
      callbacks: ["single_push", "long_push", "double_push", "triple_push"],
      icon: "../../../assets/icons/ogemray-25a.svg",
      extra: {component: "Switch"},
    },
    {
      "hostname": ["shellyplugmg3-", "ShellyPlugMG3-"],
      ...
      "triggers_2": [],
      "callbacks": ["triggerVirtualComponents"],
      "icon": "../../../assets/icons/shellyplug-m.svg",
      "extra": {"component": "Switch"}
    },
  ];
 ...
 // SUPPORTED DEVICES
 let supported_device = ['SBBT-', 'SBDI-', 'SBDW-', 'SBMO-', 'SBHT-'];
 ...
 BTH[0x2c] = { n: 'alarm_vibration', t: uint8 };
 BTH[0x2d] = { n: 'alarm_contact_window', t: uint8 };
 BTH[0x40] = { n: 'measure_distance', t: uint16, f: 0.1, u: "mm"}
